...
public class CommunityLists extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_community_lists);
...
//                Toast.makeText(getApplicationContext(), "Work in Progress", Toast.LENGTH_SHORT).show();
        ...
        String fullUrl = getResources().getString(R.string.base_url) + "getSpsWithUnreadMsgForApp/"+ category_id +"/"+settings.getString("user_id","")+"/" + settings.getString("time_strap","");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_community_lists, menu);
        return true;
    }
...
//                    Load Home buttons
                        ...
                        for (int i=0;i<response_Array.length();i+=3){
                            ...
                            textTitle1.setText(category1.getString("organisation_name"));
                            ...
                            button1.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    Intent intent = new Intent(getApplicationContext(), MessageCommunity.class);
                            ...
                            if ((i+1)<response_Array.length()){
                                ...
                                textTitle2.setText(category2.getString("organisation_name"));

                                final String fnf_id2 = category1.getString("user_id");
                                Ion.with(button2)
                                        .error(R.drawable.blue_button)
                            ...
                            if ((i+2)<response_Array.length()){
                                ...
                                textTitle3.setText(category3.getString("organisation_name"));
                                final String fnf_id3 = category1.getString("user_id");

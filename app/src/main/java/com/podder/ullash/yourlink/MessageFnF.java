...
public class MessageFnF extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_fn_f);
...
//                Reload from service
    ...
    private void loadMessages(){
        ...
        String fullUrl = getResources().getString(R.string.base_url) + "getIndividualMessage/" + fnf_id + "/" + settings.getString("user_id","");
